...
exports.useAuth = exports.authContext = exports.getCurrentUser = void 0;
...
var signup = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, api_1.signUpUser)(firebase_1.auth, email, password)];
            case 1:
...
var login = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, api_1.logInUser)(firebase_1.auth, email, password)];
            case 1:
                userCredentials = _a.sent();
                console.log(getCurrentUser());
                return [2 /*return*/, userCredentials];
...
exports.authContext = (0, react_1.createContext)({ signup: signup, login: login, getCurrentUser: getCurrentUser });
